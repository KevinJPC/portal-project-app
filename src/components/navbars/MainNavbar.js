				...
				<>
							...
							<div className='absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0'>
								{role !== 'Admin' ? (
									...
									>
										...
										>
											<Menu.Items className='fixed sm:absolute sm:text-left text-center divide-y sm:border h-screen sm:h-auto right-0 px-2 z-10 mt-4 sm:mt-2 w-screen sm:w-80 origin-top-right sm:rounded-md bg-p-blue py-3 ring-1 ring-black ring-opacity-5 focus:outline-none'>
								...
								>
									...
									<Transition
										...
										leaveTo='transform scale-95 opacity-0'
									>
										<Menu.Items className='fixed sm:absolute text-center divide-y sm:border h-screen sm:h-auto right-0 z-10 mt-4 sm:mt-2 w-screen sm:w-48 origin-top-right sm:rounded-md bg-p-blue py-3 ring-1 ring-black ring-opacity-5 focus:outline-none'>
											<Menu.Item>
					...
					<Disclosure.Panel className='sm:hidden backdrop-blur-sm '>
						<div className=' px-2 pt-2 pb-3'>
							<div className='flex flex-col w-full h-screen sm:h-auto text-center'>
								{role === 'Admin'
									? adminUserLinks.map(link => (
											<Disclosure.Button
												key={link.label}
												...
												to={link.to}
											>
												<div className='px-3 py-5 hover:bg-p-silver rounded'>
													{link.label}
												</div>
											</Disclosure.Button>
									  ))
