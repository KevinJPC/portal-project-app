...
function ShowProcessInfo({ processInfo }) {
	const { name, creationDate, activitynow, percentageAdvance } = processInfo

	return (
		<div className='flex flex-col pt-2 sm:pt-0'>
			<div className='flex justify-center py-4'>
				<div className='w-auto bg-p-gray rounded px-6'>
					<div className='md:grid md:grid-cols-2 justify-items-start text-center py-6 '>
						<div>
...
ShowProcessInfo.propTypes = {
	processInfo: PropTypes.object,
}

export default ShowProcessInfo
